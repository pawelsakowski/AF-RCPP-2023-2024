...
* Option is a contract where there are to participants: 
    ...
    * **Writer** of the option, who poseses the obligation to exercise the call/put option. Hence for call option he has to sell the underlying instrument, and for put option he has to buy underlying instrument (for the given strike price at a given moment in future). Writer takes short position in option contract.
