...
In finance, an **option** is an agreement, which gives the holder a right for **buy** or **sell** a certaing underlying instrument for a given price (*exercise price*) at a given moment in futures (*expiry date*).
...
\begin{itemize}
\item Tutorial: C++ and Rcpp for beginners\\
Romain Francois and Hadley Wickham, Rice University \\
\url{http://www.edii.uclm.es/~useR-2013/Tutorials/Francois.html}
\item \url{http://www.rinfinance.com/agenda/2014/workshop/DirkEddelbuettel.pdf}
\item \url{http://dirk.eddelbuettel.com/papers/uofc_cs_apr2013.pdf}
\item \url{http://people.math.aau.dk/~sorenh/teaching/2014-Rcpp/misc/Rcpp-workshop.pdf}
\item \url{http://dirk.eddelbuettel.com/papers/rcpp_sydney-rug_jul2013.pdf}
\item \url{http://gallery.rcpp.org/}
\item \url{http://www.rinfinance.com/agenda/2013/workshop/DirkEddelbuettel.pdf}
\end{itemize}


# Recommended readings -- Rcpp #4
\begin{itemize}
\item \url{http://dirk.eddelbuettel.com/code/rcpp.html}
\item \url{http://dirk.eddelbuettel.com/papers/rcpp_workshop_introduction_user2012.pdf}
\item \url{http://dirk.eddelbuettel.com/papers/rcpp_workshop_advanced_user2012.pdf}
\item \url{http://www.rcpp.org/}
\item \url{http://www.youtube.com/watch?v=UZkaZhsOfT4}

\item \url{http://blog.rstudio.org/2012/11/29/rstudio-and-rcpp/}
\item \url{https://github.com/hadley/devtools/wiki/Rcpp}

\item \url{http://cran.r-project.org/web/packages/Rcpp/vignettes/Rcpp-quickref.pdf}
\item \url{http://cran.rstudio.com/web/packages/Rcpp/vignettes/Rcpp-attributes.pdf} 
\end{itemize}
